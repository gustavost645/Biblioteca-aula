 ...
 */
public final class IfrListLeitores extends javax.swing.JInternalFrame {
    ...
    private void excluir() {
        ...
        int opcao = JOptionPane.showOptionDialog(null, "Deseja realmente excluir esta leitor?",
                "Aviso", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE,
                null, opcoes, opcoes[1]);
        if (opcao == JOptionPane.OK_OPTION) {
            String retorno = leitorDAO.excluir(leitor.getId());
            if (retorno == null) {
                JOptionPane.showMessageDialog(null, "Leitor excluida com sucesso");
            } else {
