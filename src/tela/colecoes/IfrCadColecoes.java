 ...
 */
public class IfrCadColecoes extends javax.swing.JDialog {
    ...
    public IfrCadColecoes(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setTitle("Cadastro de Coleções");
    }

    public IfrCadColecoes(java.awt.Frame parent, boolean modal, Colecao colecao) {
        super(parent, modal);
        initComponents();
