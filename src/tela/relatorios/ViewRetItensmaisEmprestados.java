 ...
 * @author gustavo
 */
public final class ViewRetItensmaisEmprestados extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public ViewRetItensmaisEmprestados(javax.swing.JFrame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.setTitle("Itens mais emprestados por período");
        this.frame = parent;
        setarDatas();
        TelaInterna = null;
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewRetItensmaisEmprestados.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            ViewRetItensmaisEmprestados dialog = new ViewRetItensmaisEmprestados(new javax.swing.JFrame(), true);
    ...
    private void Visualizar() {
        try {
            ...
            parametros.put("parameter1", txtDataIni.getDate());
            parametros.put("parameter2", txtDataFim.getDate());
            ifr.visualizar("/relatorios/Relacao_itens_mais_emprestados.jasper", parametros, null, ConstantesUtil.CAMINHO_SAIDA, this.getTitle());
            ifr.setVisible(true);
            ifr.setPosicao();
        } catch (Exception ex) {
