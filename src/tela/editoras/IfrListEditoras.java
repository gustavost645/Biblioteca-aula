 ...
 */
public class IfrListEditoras extends javax.swing.JInternalFrame {

    private EditoraTableModel tableModel;
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new EditoraTableModel());
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        if (evt.getClickCount() == 1) {
            editora = tableModel.getRowValue(jTable1.getSelectedRow());
        }
    }//GEN-LAST:event_jTable1MouseClicked

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        new IfrCadEditoras(null, true).setVisible(true);
        montaGrade();
    ...
    private void pesquisar() {
        try {
            ...
            ArrayList<Editora> lista = editoraDAO.consultar(txtDescricao.getText().trim());
            tableModel = new EditoraTableModel(lista);
            jTable1.setModel(tableModel);
            editora = null;

        } catch (Exception ex) {
            Logger.getLogger(IfrListEditoras.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void montaGrade() {
        try {
            ...
            ArrayList<Editora> lista = editoraDAO.consultarTodos();
            tableModel = new EditoraTableModel(lista);
            jTable1.setModel(tableModel);
            editora = null;
    ...
    private void alterar() {
        new IfrCadEditoras(null, true, editora).setVisible(true);
        montaGrade();
        editora = null;
    }
    ...
    private void excluir() {
        ...
        int opcao = JOptionPane.showOptionDialog(null, "Deseja realmente excluir esta editora?",
                "Aviso", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE,
                null, opcoes, opcoes[1]);
        if (opcao == JOptionPane.OK_OPTION) {
            String retorno = editoraDAO.excluir(editora.getId());
            if (retorno == null) {
