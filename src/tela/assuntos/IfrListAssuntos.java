 ...
 */
public final class IfrListAssuntos extends javax.swing.JInternalFrame {
     ...
     */
    public IfrListAssuntos() {
        initComponents();
        setTitle("Lista de Assuntos");
        montaGrade();
    }
    ...
    private void alterar() {
        new IfrCadAssuntos(null, true, assunto).setVisible(true);
        montaGrade();
        assunto = null;
    }
    ...
    private void excluir() {
        ...
        if (opcao == JOptionPane.OK_OPTION) {
            String retorno = assuntoDAO.excluir(assunto.getId());
            if (retorno == null) {
