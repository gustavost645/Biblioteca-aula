...
import tela.autores.AutoresTableModel;
 ...
 */
public class ListAutor extends javax.swing.JDialog {
    ...
    /**
     * Creates new form ListAutor
     * @param parent
     * @param modal
     * @param aThis
     */
    public ListAutor(java.awt.Frame parent, boolean modal,javax.swing.JDialog aThis) {
        super(parent, modal);
        initComponents();
        frame = aThis;
        montaGrade();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Digite o nome da Autor:");
        ...
        jTable1.setModel(new tela.autores.AutoresTableModel());
    ...
    private void pesquisar() {
        try {
            ...
            Logger.getLogger(ListAutor.class.getName()).log(Level.SEVERE, null, ex);
